...
TOPDIR=${UBCESLAB_SWENV_PREFIX:?undefined}/libs/vtk-dbg
...
cd $CURRENT_DIR
MODULEDIR=$UBCESLAB_SWENV_PREFIX/apps/lmod/derived_modulefiles/${COMPILER:?undefined}/${COMPILER_VERSION:?undefined}/${MPI_IMPLEMENTATION:?undefined}/${MPI_VERSION}/vtk-dbg
mkdir -p $MODULEDIR
...
echo "local name = \"vtk-dbg\"" >> $MODULEDIR/$VTK_VERSION.lua
